...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-10 md:py-20 bg-secundario">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                  ...
                  <div key={index} className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      {info.isWhatsApp && (
                        <Button
                          asChild
                          className="bg-green-600 hover:bg-green-700 text-white border-0 px-4 py-2 text-sm font-semibold"
                        >
                          <a
                            href={info.link}
                            target="_blank"
          ...
          <div className="bg-claro p-8 rounded-xl shadow-sm">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div>
                <Label htmlFor="name" className="text-principal font-medium">
                  Nome*
                </Label>
                <Input
                  id="name"
              ...
              <div>
                <Label htmlFor="email" className="text-principal font-medium">
                  E-mail*
                </Label>
                <Input
                  id="email"
              ...
              <div>
                <Label htmlFor="phone" className="text-principal font-medium">
                  Telefone*
                </Label>
                <Input
                  id="phone"
              ...
              <div>
                <Label htmlFor="message" className="text-principal font-medium">
                  Mensagem*
                </Label>
                <Textarea
                  id="message"
            ...
            <p className="text-sm text-gray-600 mt-4">
              * Campos obrigatórios. Seus dados são tratados com total
              confidencialidade.
            </p>
          </div>
        </div>
