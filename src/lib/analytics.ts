...
class AnalyticsManager {
  ...
  private async loadFacebookPixel() {
    ...
    (window as unknown as { fbq: any; _fbq: any }).fbq =
      (window as unknown as { fbq: any }).fbq ||
      function (...args: unknown[]) {
        ((window as unknown as { fbq: { q: unknown[] } }).fbq.q =
          (window as unknown as { fbq: { q: unknown[] } }).fbq.q || []).push(
          args
        );
      };
    (window as unknown as { _fbq: any; fbq: any })._fbq = (
      window as unknown as { fbq: any }
    ).fbq;
    (
      window as unknown as { fbq: { version: string; queue: unknown[] } }
    ).fbq.version = "2.0";
    (
      window as unknown as { fbq: { version: string; queue: unknown[] } }
    ).fbq.queue = [];
...
export function useAnalytics() {
  return {
    ...
    trackLegalConsultation: (service: string) =>
      analytics.trackLegalConsultation(service),
    trackWhatsAppClick: (location: string) =>
