...
export const LAWYER_PLACEHOLDERS = {
  portrait: generatePlaceholderUrl(400, 500, "Dr. Wagner Souza"),
  office: generatePlaceholderUrl(500, 600, "Advocacia Criminal"),
  ogImage: generatePlaceholderUrl(1200, 630, "Advogado Criminal"),
};
