...
import { lawyerSchema, organizationSchema, websiteSchema } from "@/lib/structured-data";

export const metadata: Metadata = {
  title: "Dra. Brennda Silva - Advocacia Especializada em São Paulo | Direito de Família, Civil e Consumidor",
  description: "Advocacia especializada com mais de 10 anos de experiência em Direito de Família, Civil, Contratos e Direito do Consumidor. Atendimento personalizado, soluções jurídicas eficazes e consulta gratuita em São Paulo. Agende sua consulta!",
  keywords: [
