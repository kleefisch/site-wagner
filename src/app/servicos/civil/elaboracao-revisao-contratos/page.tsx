...
export const metadata: Metadata = {
  title: "Elaboração e Revisão de Contratos - Advocacia Brennda Silva | Direito Civil",
  description: "Atuação especializada em elaboração, análise e revisão de contratos civis e empresariais. Segurança jurídica, prevenção de litígios e proteção dos seus interesses.",
  keywords: "contratos, elaboração de contratos, revisão de contratos, direito civil, advogada, Brennda Silva, análise contratual, segurança jurídica",
};

export default function ElaboracaoRevisaoContratosPage() {
  return (
    <>
      <Header />
      <main className="min-h-screen">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">
                Contratos bem elaborados previnem litígios, protegem direitos e garantem segurança jurídica em todas as relações civis e empresariais.
              </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Elaboração, análise e revisão de contratos civis, empresariais, de prestação de serviços, compra e venda, locação e outros.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Contratos Civis</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Contratos de compra e venda, locação, comodato, doação, mútuo, entre outros.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Redução de riscos e prevenção de litígios</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Clareza e segurança jurídica para as partes</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Contratos Empresariais</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Contratos sociais, de parceria, prestação de serviços, fornecimento, franquia, confidencialidade e outros.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Atenção a cláusulas estratégicas e obrigações</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Adequação à legislação vigente</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-2xl mx-auto">
                  Veja o passo a passo para elaboração ou revisão contratual com segurança e agilidade.
                </p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  ...
                  <p className="text-principal">
                    Análise das necessidades, objetivos e riscos envolvidos na relação contratual.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <h3 className="text-xl font-bold text-principal mb-3">2. Elaboração ou Revisão</h3>
                  <p className="text-principal">
                    Redação, análise e revisão de cláusulas, obrigações, prazos e garantias.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <h3 className="text-xl font-bold text-principal mb-3">3. Adequação e Negociação</h3>
                  <p className="text-principal">
                    Ajustes, negociações e adequação do contrato às necessidades das partes.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <h3 className="text-xl font-bold text-principal mb-3">4. Finalização e Acompanhamento</h3>
                  <p className="text-principal">
                    Assinatura, registro (se necessário) e acompanhamento para garantir o cumprimento do contrato.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                  Questões Importantes sobre Contratos
                </h2>
                <p className="text-lg text-gray-600">
                  Pontos essenciais para garantir segurança, clareza e equilíbrio nas relações contratuais.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-6 items-stretch">
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <FileText className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Por que revisar contratos?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Para evitar cláusulas abusivas, omissões e garantir que os interesses estejam protegidos.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Users className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Quais contratos precisam de atenção especial?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Contratos de alto valor, longa duração, múltiplas partes ou com cláusulas complexas.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Scale className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">O que fazer em caso de descumprimento?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Buscar orientação jurídica para exigir o cumprimento, negociar ou ingressar com ação judicial.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="text-principal text-sm flex-1">
                    Minutas, e-mails, comprovantes de negociação e registros de comunicação entre as partes.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-3xl mx-auto">
                  Contratos bem elaborados exigem conhecimento técnico, experiência e atenção aos detalhes para garantir segurança e evitar prejuízos.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="text-principal ml-1">Experiência em contratos civis e empresariais</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                      <div>
                        ...
                        <span className="text-principal ml-1">Cada contrato é analisado de forma única, buscando a melhor solução</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="text-principal ml-1">Garantia de que todos os direitos das partes sejam respeitados</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                ...
                <div className="bg-destaque rounded-2xl p-8 h-full flex flex-col justify-between text-principal">
                  ...
                  <p className="text-principal mb-6">
                    Advogada especialista em Direito Civil, com experiência em contratos, atendimento humanizado e resultados comprovados.
                  </p>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                Precisa de Contrato Personalizado ou Revisão?
              </h2>
              <p className="text-xl text-principal mb-8 max-w-2xl mx-auto">
                Conte com orientação especializada para garantir segurança e tranquilidade em suas relações contratuais.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <WhatsappButton size="lg" className="bg-destaque hover:bg-destaque/90 text-claro">
                  <span className="uppercase">INICIAR ATENDIMENTO</span>
