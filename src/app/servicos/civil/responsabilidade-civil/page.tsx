...
export const metadata: Metadata = {
  title: "Responsabilidade Civil - Advocacia Brennda Silva | Direito Civil",
  description: "Atuação especializada em responsabilidade civil: análise de casos, prevenção de riscos e defesa em ações de indenização.",
  keywords: "responsabilidade civil, direito civil, advogada, Brennda Silva, indenização, reparação de danos, prevenção de riscos",
};
      ...
      <main className="min-h-screen">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">
                Análise, prevenção e defesa em casos de responsabilidade civil, buscando justiça e segurança jurídica.
              </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Entenda os principais tipos de responsabilidade civil e como proteger seus direitos.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Responsabilidade Objetiva</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Dever de indenizar independentemente de culpa, em situações previstas em lei (ex: acidentes de consumo, atividades de risco).
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Indenização sem necessidade de comprovar culpa</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Proteção ao consumidor e à vítima</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Responsabilidade Subjetiva</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Necessidade de comprovação de culpa ou dolo para a obrigação de indenizar (ex: acidentes de trânsito, erro médico).
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Exige prova de culpa ou intenção</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Defesa técnica para comprovação dos fatos</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-2xl mx-auto">
                  Passo a passo para análise, prevenção e defesa em casos de responsabilidade civil.
                </p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  ...
                  <p className="text-principal">
                    Análise do caso, orientação sobre direitos e definição da melhor estratégia para prevenção ou defesa.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <h3 className="text-xl font-bold text-principal mb-3">2. Levantamento de Provas</h3>
                  <p className="text-principal">
                    Coleta de documentos, testemunhos e demais provas para fundamentar a defesa ou o pedido de indenização.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <h3 className="text-xl font-bold text-principal mb-3">3. Ação Judicial ou Acordo</h3>
                  <p className="text-principal">
                    Propositura de ação judicial ou negociação de acordo, conforme o caso e o interesse do cliente.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <p className="text-principal">
                    Suporte jurídico até a conclusão do caso e garantia de todos os direitos do cliente.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                  Questões Importantes sobre Responsabilidade Civil
                </h2>
              ...
              <div className="grid md:grid-cols-2 gap-6 items-stretch">
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <FileText className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Quando há responsabilidade civil?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Quando há dano causado a terceiro, seja por ação, omissão, negligência ou imprudência.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Scale className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Qual a diferença entre objetiva e subjetiva?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    A objetiva independe de culpa; a subjetiva exige comprovação de culpa ou dolo do agente.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <CheckCircle className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Como prevenir riscos de responsabilidade?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Com orientação jurídica preventiva, revisão de contratos e adoção de boas práticas.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Users className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Preciso de advogada para me defender?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Sim, a atuação de profissional especializado é fundamental para garantir seus direitos e evitar prejuízos.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-principal">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-destaque mb-4">
                  Por Que Contar com uma Advogada Especialista em Responsabilidade Civil
                </h2>
                <p className="text-lg text-claro max-w-3xl mx-auto">
                  Casos de responsabilidade civil exigem análise técnica, estratégia e experiência para garantir justiça e segurança.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                <div className="bg-secundario rounded-2xl p-8 h-full flex flex-col justify-between">
                  <h3 className="text-2xl font-bold text-principal mb-4">
                    Experiência e Segurança para Proteger Seus Direitos
                  </h3>
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="text-principal ml-1">Atuação focada em responsabilidade civil e prevenção de riscos</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                ...
                <div className="bg-destaque rounded-2xl p-8 h-full flex flex-col justify-between text-principal">
                  <h3 className="text-2xl font-bold mb-4 text-principal">Dra. Brennda: Referência em Responsabilidade Civil</h3>
                  <p className="text-principal mb-6">
                    Advogada especialista em Direito Civil, com experiência em responsabilidade civil, defesa de clientes e resultados comprovados.
                  </p>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                Precisa de Ajuda com Responsabilidade Civil?
              </h2>
              <p className="text-xl text-principal mb-8 max-w-2xl mx-auto">
                Conte com orientação especializada para proteger seus direitos e evitar prejuízos.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <WhatsappButton size="lg" className="bg-destaque hover:bg-destaque/90 text-claro">
                  <span className="uppercase">INICIAR ATENDIMENTO</span>
