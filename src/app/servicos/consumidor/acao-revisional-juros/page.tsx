...
export const metadata: Metadata = {
  title: "Ação Revisional de Juros - Advocacia Brennda Silva | Direito do Consumidor",
  description: "Atuação especializada em ação revisional de juros: revisão de contratos bancários, financiamentos, empréstimos e redução de encargos abusivos.",
  keywords: "ação revisional, juros abusivos, direito do consumidor, advogada, Brennda Silva, revisão de contrato, financiamento, empréstimo, banco",
};

export default function AcaoRevisionalJurosPage() {
  return (
    <>
      <Header />
      <main className="min-h-screen">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">
                Reduza encargos abusivos em contratos bancários, financiamentos e empréstimos. Saiba como buscar a revisão judicial dos juros.
              </p>
        ...
        {/* Modalidades de Revisão de Juros */}
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                  Situações Comuns de Juros Abusivos
                </h2>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Entenda quando é possível pedir a revisão dos juros e quais contratos podem ser revisados.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Financiamentos e Empréstimos</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Contratos bancários com taxas acima do permitido ou cobranças indevidas podem ser revisados judicialmente.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Redução de juros e encargos abusivos</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Revisão de cláusulas contratuais</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Cartão de Crédito e Cheque Especial</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Juros excessivos em cartões e cheques especiais podem ser questionados e reduzidos judicialmente.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Possibilidade de restituição de valores pagos a mais</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Ajuste do saldo devedor</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-2xl mx-auto">
                  Veja o passo a passo para buscar a revisão dos juros e encargos abusivos.
                </p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  ...
                  <p className="text-principal">
                    Análise do contrato, levantamento de taxas e identificação de abusividades.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <p className="text-principal">
                    Reunião de contratos, extratos, comprovantes de pagamento e demais documentos.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <p className="text-principal">
                    Tentativa de acordo extrajudicial ou ingresso com ação revisional para redução dos encargos.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <p className="text-principal">
                    Suporte jurídico até a conclusão do processo e ajuste do contrato.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                  Questões Importantes sobre Ação Revisional
                </h2>
                <p className="text-lg text-gray-600">
                  Tire suas dúvidas sobre revisão de juros, contratos e direitos do consumidor.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-6 items-stretch">
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <FileText className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Quando cabe ação revisional?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Quando há cobrança de juros acima do permitido, tarifas abusivas ou cláusulas ilegais em contratos bancários.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Users className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Quais contratos podem ser revisados?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Financiamentos, empréstimos, cartões de crédito, cheque especial e outros contratos bancários.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Scale className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">É possível reduzir o saldo devedor?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Sim, a revisão pode resultar na redução do saldo devedor e até na devolução de valores pagos a mais.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Handshake className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Preciso de advogado para ação revisional?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Sim, o acompanhamento de advogada especialista é fundamental para garantir seus direitos e melhores resultados.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-3xl mx-auto">
                  A revisão de juros exige conhecimento técnico e experiência para garantir seus direitos e obter a melhor solução.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="text-principal ml-1">Experiência em ações revisionais e contratos bancários</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                ...
                <div className="bg-destaque rounded-2xl p-8 h-full flex flex-col justify-between text-principal">
                  ...
                  <p className="text-principal mb-6">
                    Advogada especialista em Direito do Consumidor, com experiência em ações revisionais, atendimento humanizado e resultados comprovados.
                  </p>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                Precisa Revisar Juros ou Contratos?
              </h2>
