...
export const metadata: Metadata = {
  title: "Danos Morais e Materiais - Advocacia Brennda Silva | Direito do Consumidor",
  description: "Atuação especializada em indenizações por danos morais e materiais: defesa do consumidor, reparação de prejuízos e proteção dos seus direitos.",
  keywords: "danos morais, danos materiais, direito do consumidor, indenização, advogada, Brennda Silva, reparação de danos",
};

export default function DanosMoraisMateriaisPage() {
  return (
    <>
      <Header />
      <main className="min-h-screen">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">
                Reparação de prejuízos financeiros e emocionais sofridos pelo consumidor em razão de condutas abusivas ou ilícitas.
              </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Entenda as diferenças entre danos morais e materiais e quando é possível buscar indenização.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  ...
                  <p className="text-principal mb-6">
                    Prejuízos financeiros efetivos sofridos pelo consumidor, como cobranças indevidas, perdas, gastos extras ou danos a bens.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Restituição de valores pagos</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Reparação de prejuízos comprovados</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  ...
                  <p className="text-principal mb-6">
                    Abalo emocional, constrangimento, humilhação ou sofrimento causado por práticas abusivas, negativas indevidas ou falha na prestação de serviço.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Negativação indevida do nome</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Situações vexatórias ou discriminatórias</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  ...
                  <p className="text-principal">
                    Análise do caso, orientação sobre direitos e definição da melhor estratégia para reparação dos danos.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <p className="text-principal">
                    Reunião de provas, documentos, laudos e registros que comprovem o dano sofrido.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <p className="text-principal">
                    Envio de notificação à empresa, tentativa de acordo e, se necessário, ingresso com ação judicial.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <p className="text-principal">
                    Suporte jurídico até a solução do caso e recebimento da indenização.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                  Questões Importantes sobre Danos Morais e Materiais
                </h2>
                <p className="text-lg text-gray-600">
                  Pontos essenciais para garantir seus direitos e obter a reparação adequada.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-6 items-stretch">
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <FileText className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Quando cabe indenização por dano moral?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Quando há abalo à honra, imagem, dignidade ou sofrimento causado por conduta abusiva ou ilícita da empresa.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Users className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Como comprovar o dano material?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Por meio de documentos, notas fiscais, comprovantes de pagamento, laudos e registros do prejuízo sofrido.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Scale className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Qual o valor da indenização?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    O valor é definido pelo juiz, considerando a extensão do dano, a capacidade econômica das partes e o caráter pedagógico.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Handshake className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">É possível acumular danos morais e materiais?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Sim, quando houver prejuízo financeiro e abalo moral, é possível pleitear ambas as indenizações.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-3xl mx-auto">
                  A reparação de danos exige conhecimento técnico, experiência e estratégia para garantir indenização justa e efetiva.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="text-principal ml-1">Especialização em Direito do Consumidor e indenizações</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                ...
                <div className="bg-destaque rounded-2xl p-8 h-full flex flex-col justify-between text-principal">
                  ...
                  <p className="text-principal mb-6">
                    Advogada especialista em Direito do Consumidor, com experiência em indenizações, atendimento humanizado e resultados comprovados.
                  </p>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                Sofreu Danos Morais ou Materiais?
              </h2>
              <p className="text-xl text-principal mb-8 max-w-2xl mx-auto">
                Conte com orientação especializada para buscar a reparação justa e proteger seus direitos.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <WhatsappButton size="lg" className="bg-destaque hover:bg-destaque/90 text-claro">
                  <span className="uppercase">INICIAR ATENDIMENTO</span>
