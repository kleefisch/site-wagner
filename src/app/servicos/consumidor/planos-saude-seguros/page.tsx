...
export const metadata: Metadata = {
  title: "Planos de Saúde e Seguros - Advocacia Brennda Silva | Direito do Consumidor",
  description: "Atuação especializada em planos de saúde e seguros: negativas de cobertura, reajustes abusivos, carência, reembolso e defesa dos direitos do consumidor.",
  keywords: "planos de saúde, seguros, direito do consumidor, advogada, Brennda Silva, negativa de cobertura, reajuste abusivo, carência, reembolso",
};

export default function PlanosSaudeSegurosPage() {
  return (
    <>
      <Header />
      <main className="min-h-screen">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">
                Defesa dos direitos do consumidor em casos de negativas de cobertura, reajustes abusivos, carência e problemas com seguros.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Negativa de Cobertura</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Recusa de procedimentos, exames, cirurgias ou medicamentos pelo plano de saúde ou seguro pode ser questionada judicialmente.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Direito à cobertura de procedimentos essenciais</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Possibilidade de indenização por danos morais</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Reajuste Abusivo e Carência</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Aumentos excessivos, aplicação indevida de carência ou negativa de reembolso podem ser contestados.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Revisão de reajustes e cobranças indevidas</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Garantia de acesso ao tratamento necessário</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-2xl mx-auto">
                  Veja o passo a passo para buscar seus direitos em casos de problemas com planos de saúde e seguros.
                </p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  ...
                  <p className="text-principal">
                    Reunião de contratos, laudos médicos, negativas, boletins de ocorrência e comprovantes.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <h3 className="text-xl font-bold text-principal mb-3">3. Proposta de Acordo ou Ação Judicial</h3>
                  <p className="text-principal">
                    Tentativa de solução administrativa ou ingresso com ação judicial para garantir direitos e indenizações.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                  Questões Importantes sobre Planos de Saúde e Seguros
                </h2>
              ...
              <div className="grid md:grid-cols-2 gap-6 items-stretch">
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <FileText className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">O que fazer em caso de negativa de cobertura?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Solicite a negativa por escrito, reúna documentos e procure orientação jurídica para buscar a cobertura ou indenização.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Users className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Como agir diante de reajuste abusivo?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Questione o reajuste, solicite explicações e, se necessário, busque a revisão judicial do valor cobrado.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="text-principal text-sm flex-1">
                    Contrato, laudos médicos, negativas, comprovantes de pagamento e boletins de ocorrência.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="text-principal text-sm flex-1">
                    Sempre que houver prejuízo material ou moral decorrente de negativa indevida ou falha na prestação do serviço.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-3xl mx-auto">
                  Questões de planos de saúde e seguros exigem conhecimento técnico e experiência para garantir seus direitos e obter a melhor solução.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="text-principal ml-1">Experiência em demandas contra planos de saúde e seguros</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                ...
                <div className="bg-destaque rounded-2xl p-8 h-full flex flex-col justify-between text-principal">
                  ...
                  <p className="text-principal mb-6">
                    Advogada especialista em Direito do Consumidor, com experiência em demandas contra planos de saúde e seguros, atendimento humanizado e resultados comprovados.
                  </p>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                Teve Problemas com Plano de Saúde ou Seguro?
              </h2>
