...
export const metadata: Metadata = {
  title: "Telefonia, Internet e TV - Advocacia Brennda Silva | Direito do Consumidor",
  description: "Atuação especializada em defesa do consumidor contra abusos de operadoras de telefonia, internet e TV: cobranças indevidas, falha de serviço, cancelamento e indenização.",
  keywords: "telefonia, internet, TV, direito do consumidor, advogada, Brennda Silva, cobrança indevida, falha de serviço, cancelamento, indenização",
};

export default function TelefoniaInternetTvPage() {
  return (
    <>
      <Header />
      <main className="min-h-screen">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">
                Defesa dos seus direitos em casos de cobranças indevidas, falha na prestação de serviço, cancelamento e problemas com operadoras.
              </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                  Problemas Comuns em Telefonia, Internet e TV
                </h2>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Conheça as principais situações que afetam consumidores e como buscar seus direitos.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Cobranças Indevidas</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Valores não reconhecidos em faturas, serviços não contratados ou cobranças após cancelamento.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Pacotes extras, roaming, ligações não realizadas</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Cobrança após pedido de cancelamento</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Falha na Prestação de Serviço</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Interrupção frequente, baixa qualidade, demora no reparo ou não entrega do serviço contratado.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Internet lenta, sinal instável, quedas de conexão</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Demora para instalação ou reparo</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  ...
                  <p className="text-principal">
                    Reunião de provas, faturas, protocolos de atendimento e registros das falhas ou cobranças.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <p className="text-principal">
                    Envio de notificação à operadora, tentativa de acordo e, se necessário, ingresso com ação judicial.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                  Questões Importantes sobre Telefonia, Internet e TV
                </h2>
                <p className="text-lg text-gray-600">
                  Pontos essenciais para garantir seus direitos e evitar prejuízos com operadoras.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-6 items-stretch">
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <FileText className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">O que fazer diante de cobrança indevida?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Contestar imediatamente, reunir provas e buscar orientação jurídica para reverter a cobrança.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Users className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Tenho direito a desconto por falha de serviço?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Sim, o consumidor pode exigir abatimento proporcional do valor pago quando o serviço não é prestado adequadamente.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Scale className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Como cancelar o serviço sem multa?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    O cancelamento pode ser feito a qualquer tempo, sem multa, se houver descumprimento do contrato pela operadora.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Handshake className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Posso pedir indenização por danos?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Sim, em caso de prejuízo financeiro ou abalo moral, é possível pleitear indenização judicialmente.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-3xl mx-auto">
                  A defesa contra abusos de operadoras exige conhecimento técnico, experiência e agilidade para garantir seus direitos.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="text-principal ml-1">Especialização em Direito do Consumidor e telecomunicações</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                ...
                <div className="bg-destaque rounded-2xl p-8 h-full flex flex-col justify-between text-principal">
                  ...
                  <p className="text-principal mb-6">
                    Advogada especialista em Direito do Consumidor, com experiência em telecomunicações, atendimento humanizado e resultados comprovados.
                  </p>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                Problemas com Telefonia, Internet ou TV?
              </h2>
              <p className="text-xl text-principal mb-8 max-w-2xl mx-auto">
                Conte com orientação especializada para resolver conflitos e garantir seus direitos como consumidor.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <WhatsappButton size="lg" className="bg-destaque hover:bg-destaque/90 text-claro">
                  <span className="uppercase">INICIAR ATENDIMENTO</span>
