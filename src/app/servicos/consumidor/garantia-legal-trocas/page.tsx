...
export const metadata: Metadata = {
  title: "Garantia Legal e Trocas - Advocacia Brennda Silva | Direito do Consumidor",
  description: "Atuação especializada em garantia legal, trocas e devoluções: direitos do consumidor, prazos, vícios de produto e suporte jurídico completo.",
  keywords: "garantia legal, troca de produto, direito do consumidor, advogada, Brennda Silva, vício de produto, devolução, assistência técnica",
};

export default function GarantiaLegalTrocasPage() {
  return (
    <>
      <Header />
      <main className="min-h-screen">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-claro mb-6">
                Garantia Legal e Trocas
              </h1>
              <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">
                Saiba como garantir seus direitos em casos de defeitos, vícios, trocas e devoluções de produtos ou serviços.
              </p>
        ...
        {/* Modalidades de Garantia e Troca */}
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                  Tipos de Garantia e Situações de Troca
                </h2>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Entenda as diferenças entre garantia legal, contratual e estendida, e quando você tem direito à troca ou devolução.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Garantia Legal</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Direito previsto em lei, independente de contrato, para produtos e serviços com defeito ou vício.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">30 dias para bens não duráveis e 90 dias para bens duráveis</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Independe de termo ou certificado</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Garantia Contratual e Estendida</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Oferecida pelo fabricante ou vendedor, pode ampliar o prazo e as condições da garantia legal.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Deve ser formalizada por escrito</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Soma-se ao prazo da garantia legal</span>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        {/* Como Funciona o Processo de Troca ou Garantia */}
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-2xl mx-auto">
                  Entenda o passo a passo para exigir seus direitos em caso de defeito, vício ou necessidade de troca.
                </p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  ...
                  <p className="text-principal">
                    Reunião de notas fiscais, certificados, fotos e registros do defeito ou vício.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <h3 className="text-xl font-bold text-principal mb-3">3. Acionamento da Garantia ou Troca</h3>
                  <p className="text-principal">
                    Solicitação junto ao fornecedor, fabricante ou loja, com prazo para solução do problema.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <p className="text-principal">
                    Suporte jurídico até a solução definitiva, troca, devolução ou indenização.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                  Questões Importantes sobre Garantia e Troca
                </h2>
                <p className="text-lg text-gray-600">
                  Fique atento aos prazos, documentos e procedimentos para não perder seus direitos.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-6 items-stretch">
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <FileText className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Quais são os prazos de garantia?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    30 dias para bens não duráveis e 90 dias para bens duráveis, contados do recebimento do produto ou término do serviço.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Users className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Quando posso exigir a troca?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Quando o defeito não for sanado em até 30 dias, o consumidor pode exigir troca, devolução do valor ou abatimento proporcional.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Scale className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">E se a loja se recusar a trocar?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Procure orientação jurídica para exigir seus direitos e, se necessário, acionar órgãos de defesa do consumidor ou o Judiciário.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="text-principal text-sm flex-1">
                    Nota fiscal, certificado de garantia, fotos do defeito e registros de contato com o fornecedor.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-3xl mx-auto">
                  Garantia e troca exigem conhecimento técnico e experiência para garantir seus direitos e obter a melhor solução.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="text-principal ml-1">Experiência em demandas de garantia e troca</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                ...
                <div className="bg-destaque rounded-2xl p-8 h-full flex flex-col justify-between text-principal">
                  ...
                  <p className="text-principal mb-6">
                    Advogada especialista em Direito do Consumidor, com experiência em demandas de garantia, troca e devolução, atendimento humanizado e resultados comprovados.
                  </p>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                Teve Problemas com Garantia ou Troca?
              </h2>
