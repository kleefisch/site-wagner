...
export const metadata: Metadata = {
  title: "Inventário e Herança - Advocacia Brennda Silva | Especialista em Direito de Família",
  description: "Atuação especializada em inventário, partilha de bens, regularização de herança e orientação completa para herdeiros.",
  keywords: "inventário, herança, partilha de bens, direito de família, advogada, Brennda Silva, regularização de bens, sucessão",
};

export default function InventarioHerancaPage() {
  return (
    <>
      <Header />
      <main className="min-h-screen">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">
                Segurança jurídica, agilidade e orientação completa para regularizar bens, direitos e obrigações após o falecimento de um ente querido.
              </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Entenda as modalidades de inventário e escolha a mais adequada para sua família.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Inventário Judicial</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Realizado perante o Judiciário, obrigatório quando há herdeiros incapazes, testamento ou discordância entre os envolvidos.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Segurança jurídica em situações complexas</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Acompanhamento em todas as etapas do processo</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Inventário Extrajudicial</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Feito em cartório, mais rápido e simples, possível quando todos os herdeiros são capazes e estão de acordo.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Agilidade e menor burocracia</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Redução de custos e tempo</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  ...
                  <p className="text-principal">
                    Análise completa do caso, esclarecimento de dúvidas e definição da melhor estratégia para o inventário.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                ...
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  ...
                  <p className="text-principal">
                    Cuidamos de toda a parte técnica e burocrática do inventário, garantindo agilidade e precisão em cada etapa.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                  Questões Importantes sobre Inventário e Herança
                </h2>
                <p className="text-lg text-gray-600">
                  Pontos essenciais que precisam ser definidos e esclarecidos para garantir uma partilha justa e segura.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-6 items-stretch">
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Users className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Quem pode ser herdeiro?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Cônjuges, filhos, companheiros, pais e outros familiares podem ter direito à herança, conforme a lei.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <FileText className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Como ocorre a partilha?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    A divisão dos bens segue regras legais, podendo ser ajustada por acordo entre os herdeiros ou testamento.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="text-principal text-sm flex-1">
                    Certidões, documentos pessoais, certidões de bens e dívidas, entre outros, são essenciais para o processo.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Scale className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">E se houver dívidas?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    As dívidas do falecido podem ser pagas com os bens do espólio antes da partilha entre os herdeiros.
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* Por Que a Presença de Uma Advogada Especialista Faz Toda a Diferença (SEMPRE igual) */}
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-3xl mx-auto">
                  O inventário e a partilha de herança exigem conhecimento técnico, agilidade e atenção aos detalhes para garantir uma divisão justa, evitar conflitos e proteger o patrimônio da família.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                ...
                <div className="bg-destaque rounded-2xl p-8 h-full flex flex-col justify-between text-principal">
                  ...
                  <p className="text-principal mb-6">
                    Advogada especialista em Direito de Família, com ampla experiência, atendimento humanizado, ética profissional e resultados comprovados.
                  </p>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                Precisa de Ajuda com Inventário ou Herança?
              </h2>
              <p className="text-xl text-principal mb-8 max-w-2xl mx-auto">
                Conte com orientação especializada, agilidade e segurança para regularizar a herança e proteger seus direitos.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <WhatsappButton size="lg" className="bg-destaque hover:bg-destaque/90 text-claro">
                  <span className="uppercase">INICIAR ATENDIMENTO</span>
