...
export const metadata: Metadata = {
  title: "Pacto Antenupcial e Contratos - Advocacia Brennda Silva | Direito de Família e Patrimonial",
  description: "Atuação especializada em elaboração de pacto antenupcial, contratos de união estável e acordos patrimoniais. Segurança jurídica para casais e famílias.",
  keywords: "pacto antenupcial, contratos, união estável, direito de família, advogada, Brennda Silva, contratos patrimoniais",
};

export default function PactoAntenupcialContratosPage() {
  return (
    <>
      <Header />
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                  Modalidades de Contratos e Pactos
                </h2>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Conheça os principais instrumentos jurídicos para proteção patrimonial e organização da vida a dois.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Pacto Antenupcial</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Instrumento que define o regime de bens e regras patrimoniais antes do casamento, garantindo segurança e clareza para o casal.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Personalização do regime de bens</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Evita conflitos futuros</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Contrato de União Estável</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Formaliza direitos e deveres do casal em união estável, incluindo regime de bens, partilha e questões patrimoniais.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Reconhecimento legal da união</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Definição clara de direitos e deveres</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  ...
                  <p className="text-principal">
                    Entendimento das necessidades do casal e orientação sobre as melhores opções contratuais.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <h3 className="text-xl font-bold text-principal mb-3">2. Elaboração do Contrato</h3>
                  <p className="text-principal">
                    Redação personalizada do pacto antenupcial ou contrato de união estável, conforme a vontade das partes.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <h3 className="text-xl font-bold text-principal mb-3">3. Assinatura e Registro</h3>
                  <p className="text-principal">
                    Orientação sobre assinatura, reconhecimento de firma e registro em cartório, quando necessário.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <p className="text-principal">
                    Suporte jurídico contínuo para esclarecimento de dúvidas e eventuais revisões contratuais.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                  Questões Importantes sobre Pactos e Contratos
                </h2>
                <p className="text-lg text-gray-600">
                  Pontos essenciais para garantir validade, segurança e tranquilidade ao casal.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-6 items-stretch">
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <FileText className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Quando é obrigatório o pacto antenupcial?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    O pacto é obrigatório para regimes de bens diferentes da comunhão parcial, como separação total ou comunhão universal.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Users className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Contrato de união estável precisa ser registrado?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Não é obrigatório, mas o registro em cartório garante maior segurança jurídica e publicidade ao acordo.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Scale className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Posso alterar o regime de bens depois?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Sim, é possível mediante autorização judicial e concordância de ambos, respeitando requisitos legais.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Handshake className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Quais cláusulas podem ser incluídas?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    O pacto pode prever regras sobre administração de bens, partilha, doações, herança e outros acordos lícitos.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-3xl mx-auto">
                  A elaboração de pactos e contratos exige conhecimento técnico, atenção aos detalhes e experiência para garantir segurança e validade jurídica.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="text-principal ml-1">Especialização em Direito de Família e Patrimonial</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                      <div>
                        ...
                        <span className="text-principal ml-1">Contratos sob medida para cada realidade</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                      <div>
                        ...
                        <span className="text-principal ml-1">Redução de riscos e litígios futuros</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                      <div>
                        ...
                        <span className="text-principal ml-1">Garantia de validade e proteção dos interesses do casal</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                      <div>
                        ...
                        <span className="text-principal ml-1">Atenção, empatia e clareza em todas as etapas</span>
                      </div>
                    </li>
                  </ul>
                </div>
                <div className="bg-destaque rounded-2xl p-8 h-full flex flex-col justify-between text-principal">
                  ...
                  <p className="text-principal mb-6">
                    Advogada especialista em Direito de Família e Patrimonial, com experiência em contratos, pactos e soluções jurídicas personalizadas.
                  </p>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-base text-principal">Atuação estratégica com foco em prevenção</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="bg-principal rounded-full p-1">
                        <CheckCircle className="w-4 h-4 text-destaque" />
