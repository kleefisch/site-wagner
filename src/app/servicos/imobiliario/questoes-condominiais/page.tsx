...
export const metadata: Metadata = {
  title: "Questões Condominiais - Advocacia Brennda Silva | Direito Imobiliário",
  description: "Atuação especializada em questões condominiais: assembleias, cobrança de taxas, conflitos entre condôminos, assessoria para síndicos e moradores.",
  keywords: "questões condominiais, direito imobiliário, condomínio, síndico, taxa condominial, advogada, Brennda Silva, assembleia, conflitos condominiais",
};

export default function QuestoesCondominiaisPage() {
  return (
    <>
      <Header />
      <main className="min-h-screen">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">
                Soluções jurídicas para síndicos, condôminos e administradoras: assembleias, cobranças, conflitos e assessoria completa.
              </p>
        ...
        {/* Modalidades de Questões Condominiais */}
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                  Principais Questões Condominiais
                </h2>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Conheça os temas mais comuns e como a assessoria jurídica pode ajudar.
                </p>
              </div>
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Cobrança de Taxas</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Assessoria para cobrança de inadimplentes, negociação e ações judiciais para recebimento de taxas condominiais.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Recuperação de receitas do condomínio</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Ações rápidas e eficazes</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Conflitos entre Condôminos</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Mediação e solução de conflitos, orientação sobre direitos e deveres, atuação em assembleias.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Prevenção de litígios e clima harmônico</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Atuação em assembleias e reuniões</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Assessoria para Síndicos</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Orientação jurídica para síndicos em gestão, contratos, prestação de contas e obrigações legais.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Gestão eficiente e transparente</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Redução de riscos e passivos</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-2xl mx-auto">
                  Passo a passo para solução de questões condominiais com segurança e agilidade.
                </p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  ...
                  <p className="text-principal">
                    Análise do caso, orientação sobre direitos e deveres e definição da melhor estratégia.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <p className="text-principal">
                    Reunião de convenção, regimento, atas e demais documentos necessários.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <h3 className="text-xl font-bold text-principal mb-3">3. Mediação e Solução de Conflitos</h3>
                  <p className="text-principal">
                    Atuação em negociações, mediação e processos judiciais para resolver impasses.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <h3 className="text-xl font-bold text-principal mb-3">4. Acompanhamento e Prevenção</h3>
                  <p className="text-principal">
                    Suporte contínuo para evitar novos conflitos e garantir a regularidade do condomínio.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                  Questões Importantes sobre Condomínios
                </h2>
                <p className="text-lg text-gray-600">
                  Pontos essenciais para evitar problemas e garantir a harmonia condominial.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-6 items-stretch">
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <FileText className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Como cobrar taxas em atraso?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Notificação, negociação e, se necessário, ação judicial para recebimento das taxas.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Users className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Como resolver conflitos entre vizinhos?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Mediação, assembleias e, se necessário, atuação judicial para garantir a paz condominial.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Building className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Quais as obrigações do síndico?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Gestão financeira, prestação de contas, cumprimento da convenção e representação legal do condomínio.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-3xl mx-auto">
                  Questões condominiais exigem conhecimento técnico e estratégia para garantir segurança e evitar conflitos.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                <div className="bg-secundario rounded-2xl p-8 h-full flex flex-col justify-between">
                  <h3 className="text-2xl font-bold text-principal mb-4">
                    Experiência que Protege Seu Condomínio
                  </h3>
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="text-principal ml-1">Especialização em Direito Imobiliário e condomínios</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="text-principal ml-1">Busca de acordos e defesa firme em assembleias e processos</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                ...
                <div className="bg-destaque rounded-2xl p-8 h-full flex flex-col justify-between text-principal">
                  ...
                  <p className="text-principal mb-6">
                    Advogada especialista em Direito Imobiliário, com experiência em condomínios, atendimento humanizado e resultados comprovados.
                  </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-principal mb-8 max-w-2xl mx-auto">
                Conte com orientação especializada para garantir a harmonia e legalidade do seu condomínio.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <WhatsappButton size="lg" className="bg-destaque hover:bg-destaque/90 text-claro">
                  <span className="uppercase">INICIAR ATENDIMENTO</span>
