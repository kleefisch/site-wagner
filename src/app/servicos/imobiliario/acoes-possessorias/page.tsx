...
export const metadata: Metadata = {
  title: "Ações Possessórias - Advocacia Brennda Silva | Direito Imobiliário",
  description: "Atuação especializada em ações possessórias: reintegração de posse, manutenção de posse, interdito proibitório. Proteção jurídica do seu imóvel.",
  keywords: "ações possessórias, direito imobiliário, reintegração de posse, manutenção de posse, interdito proibitório, advogada, Brennda Silva, posse de imóvel",
};

export default function AcoesPossessoriasPage() {
  return (
    <>
      <Header />
      <main className="min-h-screen">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">
                Proteja sua posse e propriedade: reintegração, manutenção e interdito proibitório para garantir seus direitos sobre o imóvel.
              </p>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Conheça as principais ações para proteger sua posse e propriedade.
                </p>
              </div>
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Reintegração de Posse</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Recuperação da posse do imóvel em caso de esbulho (perda injusta da posse).
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Ação rápida para retomada do imóvel</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Prova da posse anterior é fundamental</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Manutenção de Posse</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Proteção contra turbação (ameaça ou perturbação da posse), garantindo a permanência no imóvel.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Evita perda da posse por ameaças ou invasões</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Ação preventiva e protetiva</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-2xl font-bold text-principal">Interdito Proibitório</h3>
                  </div>
                  <p className="text-principal mb-6">
                    Medida para evitar ameaça iminente à posse, impedindo turbação ou esbulho.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Ação preventiva para evitar conflitos</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-destaque flex-shrink-0 mt-0.5" />
                      <span className="text-sm text-gray-600">Protege a posse sem necessidade de perda efetiva</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-2xl mx-auto">
                  Entenda as etapas para garantir a proteção do seu imóvel.
                </p>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  ...
                  <p className="text-principal">
                    Análise do caso, orientação sobre direitos e definição da melhor estratégia para a posse.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <p className="text-principal">
                    Reunião de documentos que comprovem a posse e eventuais provas de esbulho ou turbação.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <p className="text-principal">
                    Ingresso com a ação possessória adequada (reintegração, manutenção ou interdito) conforme o caso.
                  </p>
                </div>
                <div className="text-center bg-white rounded-2xl p-6 shadow-lg">
                  <div className="bg-destaque/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 border border-destaque/50 shadow-md">
                  ...
                  <p className="text-principal">
                    Suporte jurídico até a efetiva proteção da posse e cumprimento da decisão judicial.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                  Questões Importantes sobre Ações Possessórias
                </h2>
                <p className="text-lg text-gray-600">
                  Pontos essenciais para garantir a posse e evitar prejuízos.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-6 items-stretch">
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <FileText className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Quando cabe cada tipo de ação?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Reintegração: perda da posse. Manutenção: ameaça ou turbação. Interdito: risco iminente de perda.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Users className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">Preciso de provas para ajuizar a ação?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Sim, documentos, fotos, testemunhas e registros ajudam a comprovar a posse e o esbulho/turbação.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                    <Building className="w-6 h-6 text-destaque" />
                    <h3 className="font-bold text-principal">A decisão é rápida?</h3>
                  </div>
                  <p className="text-principal text-sm flex-1">
                    Em casos urgentes, é possível obter liminar para proteção imediata da posse.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex flex-col">
                  <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="text-principal text-sm flex-1">
                    A experiência e conhecimento técnico são essenciais para o sucesso da ação e proteção do seu patrimônio.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-claro max-w-3xl mx-auto">
                  Ações possessórias exigem conhecimento técnico e estratégia para garantir a posse e evitar prejuízos.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                <div className="bg-secundario rounded-2xl p-8 h-full flex flex-col justify-between">
                  <h3 className="text-2xl font-bold text-principal mb-4">
                    Experiência que Protege Seu Imóvel
                  </h3>
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="text-principal ml-1">Especialização em Direito Imobiliário e ações possessórias</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <span className="text-principal ml-1">Busca de acordos e defesa firme em processos judiciais</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                      <div>
                        ...
                        <span className="text-principal ml-1">Garantia de que todos os direitos sobre o imóvel sejam respeitados</span>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-6 h-6 text-destaque flex-shrink-0 mt-1" />
                ...
                <div className="bg-destaque rounded-2xl p-8 h-full flex flex-col justify-between text-principal">
                  ...
                  <p className="text-principal mb-6">
                    Advogada especialista em Direito Imobiliário, com experiência em ações possessórias, atendimento humanizado e resultados comprovados.
                  </p>
        ...
        <section className="py-16 bg-secundario">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl lg:text-4xl font-bold text-principal mb-4">
                Precisa de Ajuda com Ações Possessórias?
              </h2>
              <p className="text-xl text-principal mb-8 max-w-2xl mx-auto">
                Conte com orientação especializada para proteger seu imóvel e garantir seus direitos.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <WhatsappButton size="lg" className="bg-destaque hover:bg-destaque/90 text-claro">
                  <span className="uppercase">INICIAR ATENDIMENTO</span>
